...
import { BottomWorkbenchPanel } from '../features/simulation/BottomWorkbenchPanel';
...
export const App = () => {
  ...
  useEffect(() => {
    if (presentationMode === 'simulation' && activeCanvasTool === 'connect') {
