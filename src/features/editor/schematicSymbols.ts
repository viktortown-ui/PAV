...
const HEATER_VARIANTS = {
  'heat-exchanger': { variant: 'heat-exchanger', size: { width: 132, height: 74 } },
  heater: { variant: 'heater', size: { width: 128, height: 72 } },
  cooler: { variant: 'cooler', size: { width: 128, height: 72 } },
} as const;
