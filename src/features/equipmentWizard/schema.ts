...
const commonFields: EquipmentWizardField[] = [
  { key: 'visibleName', label: 'Наименование', type: 'text', required: true, source: 'top-level' },
...
const wizardFieldMap: Partial<Record<SoapNodeKind, EquipmentWizardField[]>> = {
  ...
  manualValve: [...commonFields, { key: 'valveType', label: 'Тип клапана', type: 'text', required: true, source: 'process' }, { key: 'normallyOpen', label: 'Нормальное положение', type: 'select', required: true, source: 'process', options: [select('Нормально открыт', 'true'), select('Нормально закрыт', 'false')] }, { key: 'failPosition', label: 'Положение при отказе', type: 'select', required: true, source: 'process', options: failPositionOptions }],
  ...
  pressureSensor: [...commonFields, { key: 'measuredProperty', label: 'Измеряемый параметр', type: 'select', required: true, source: 'process', options: signalOptions }, { key: 'unit', label: 'Единицы', type: 'text', required: true, source: 'process' }, { key: 'warnLow', label: 'Нижний порог', type: 'number', required: true, source: 'process' }, { key: 'warnHigh', label: 'Верхний порог', type: 'number', required: true, source: 'process' }],
  flowMeter: [...commonFields, { key: 'measuredProperty', label: 'Измеряемый параметр', type: 'select', required: true, source: 'process', options: signalOptions }, { key: 'unit', label: 'Единицы', type: 'text', required: true, source: 'process' }, { key: 'warnLow', label: 'Нижний порог', type: 'number', required: true, source: 'process' }, { key: 'warnHigh', label: 'Верхний порог', type: 'number', required: true, source: 'process' }],
  temperatureSensor: [...commonFields, { key: 'measuredProperty', label: 'Измеряемый параметр', type: 'select', required: true, source: 'process', options: signalOptions }, { key: 'unit', label: 'Единицы', type: 'text', required: true, source: 'process' }, { key: 'warnLow', label: 'Нижний порог', type: 'number', required: true, source: 'process' }, { key: 'warnHigh', label: 'Верхний порог', type: 'number', required: true, source: 'process' }],
  levelSensor: [...commonFields, { key: 'measuredProperty', label: 'Измеряемый параметр', type: 'select', required: true, source: 'process', options: signalOptions }, { key: 'unit', label: 'Единицы', type: 'text', required: true, source: 'process' }, { key: 'warnLow', label: 'Нижний порог', type: 'number', required: true, source: 'process' }, { key: 'warnHigh', label: 'Верхний порог', type: 'number', required: true, source: 'process' }],
  phSensor: [...commonFields, { key: 'measuredProperty', label: 'Измеряемый параметр', type: 'select', required: true, source: 'process', options: signalOptions }, { key: 'unit', label: 'Единицы', type: 'text', required: true, source: 'process' }, { key: 'warnLow', label: 'Нижний порог', type: 'number', required: true, source: 'process' }, { key: 'warnHigh', label: 'Верхний порог', type: 'number', required: true, source: 'process' }],
  conductivitySensor: [...commonFields, { key: 'measuredProperty', label: 'Измеряемый параметр', type: 'select', required: true, source: 'process', options: signalOptions }, { key: 'unit', label: 'Единицы', type: 'text', required: true, source: 'process' }, { key: 'warnLow', label: 'Нижний порог', type: 'number', required: true, source: 'process' }, { key: 'warnHigh', label: 'Верхний порог', type: 'number', required: true, source: 'process' }],
  indicator: [...commonFields, { key: 'measuredProperty', label: 'Измеряемый параметр', type: 'select', required: true, source: 'process', options: signalOptions }, { key: 'unit', label: 'Единицы', type: 'text', required: true, source: 'process' }, { key: 'warnLow', label: 'Нижний порог', type: 'number', required: true, source: 'process' }, { key: 'warnHigh', label: 'Верхний порог', type: 'number', required: true, source: 'process' }],
};
