...
import { BottomDockState, BottomTab, BottomWorkbenchState, defaultBottomWorkbenchState, selectionOpensBottomPanel } from '../features/simulation/selectionController';
...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  selectNode: (selectedNodeId) => set((state) => ({ selectedNodeId, selectedEdgeId: undefined, selectedMeasurementPointId: undefined, hoveredEdgeId: undefined, edgeEditorMode: undefined, pathSelection: computePathSelection(state.project, selectedNodeId, undefined), bottomWorkbench: selectionOpensBottomPanel(selectedNodeId, undefined) })),
  selectEdge: (selectedEdgeId) => set((state) => ({ selectedEdgeId, selectedNodeId: undefined, selectedMeasurementPointId: undefined, hoveredEdgeId: selectedEdgeId ?? state.hoveredEdgeId, edgeEditorMode: selectedEdgeId ? 'actions' : undefined, pathSelection: computePathSelection(state.project, undefined, selectedEdgeId), bottomWorkbench: selectionOpensBottomPanel(undefined, selectedEdgeId) })),
  selectMeasurementPoint: (selectedMeasurementPointId) => set(() => ({ selectedMeasurementPointId, selectedNodeId: undefined, selectedEdgeId: undefined, hoveredEdgeId: undefined, edgeEditorMode: undefined, pathSelection: { upstream: [], downstream: [], edges: [] }, bottomWorkbench: defaultBottomWorkbenchState })),
  setBottomWorkbenchDock: (dock) => set((state) => ({ bottomWorkbench: { ...state.bottomWorkbench, dock } })),
  setBottomWorkbenchTab: (activeTab) => set((state) => ({ bottomWorkbench: { ...state.bottomWorkbench, activeTab } })),
  closeBottomWorkbench: () => set(() => ({ bottomWorkbench: defaultBottomWorkbenchState, selectedNodeId: undefined, selectedEdgeId: undefined, pathSelection: { upstream: [], downstream: [], edges: [] } })),
